...
{ 
	...
	/** 諏訪子の帽子の素材性能 */
	public static final IArmorMaterial armorMaterial_Suwako   = addArmorMaterial("suwao", 1, new int[]{1, 1, 1,1}, 0);
	...
	public static void setItems()
	{
		/* 五つの難題 ＋ 新難題 */
		//蓬莱の玉の枝
		//hourai_Jeweled_branch = new ItemHouraiJeweledBranch().setRegistryName("houraiJewelBranch");
		//龍の頸の玉
		...
		//エイジャの赤石
		//aja_red_stone = new ItemAjaRedStone().setRegistryName("ajaRedStone");
		...
		//魔理沙の帽子
		marisa_hat = new ItemMarisaHat(armorMaterial_Marisa);
		...
		/* 東方風神録 */
		//河童の帽子
		kappa_cap = new ItemKappaCap(armorMaterial_Hinezumi);
		//河童の水鉄砲
		...
		//諏訪子の帽子
		suwako_hat = new ItemKerobou(armorMaterial_Suwako);
	...
	private static IArmorMaterial addArmorMaterial(String name, int durability, int[] damangeReduction, int enchantability) {
		return addArmorMaterial(name, durability, damangeReduction, enchantability,
