...
public class ModelCirno extends EntityModel<EntityCirno> {
	...
	// RendererModel base;
	RendererModel longHair;
	RendererModel ribbonCenter;
	...
	public ModelCirno() {
		...
		longHair = new RendererModel(this, 24, 0);
		...
		// リボン
		ribbonCenter = new RendererModel(this, 0, 32);
		...
		ribbonLeft = new RendererModel(this, 6, 32);
		...
		ribbonRight = new RendererModel(this, 6, 32);
		...
		body = new RendererModel(this, 32, 8);
		...
		rightArm = new RendererModel(this, 48, 0);
		...
		/*
		 * rightArm = new RendererModel(this, 48, 3); rightArm.addBox(-1F, -1F, -1F, 2,
		 * 8, 2); rightArm.setRotationPoint(4F, 1F, 0F); //rightArm.setTextureSize(64,
		 * 64); //rightArm.mirror = true; //setRotation(rightArm, -1.291544F,
		 * -1.375609F, 0F); setRotation(rightArm, 0.7679449F, 0F, 0.6457718F);
		 */
		leftArm = new RendererModel(this, 56, 0);
		leftArm.addBox(-1F, -1F, -1F, 2, 8, 2);
		leftArm.setRotationPoint(4F, 6F, 0F);
		// leftArm.setTextureSize(64, 64);
		// leftArm.mirror = true;
		setRotation(leftArm, -0.7679449F, 0F, 0.6457718F);
		rightLeg = new RendererModel(this, 50, 16);
		rightLeg.addBox(-1F, 0F, -2F, 3, 12, 4);
		rightLeg.setRotationPoint(-2F, 12F, 0F);
		// rightLeg.setTextureSize(64, 64);
		// rightLeg.mirror = true;
		setRotation(rightLeg, 0F, 0F, 0F);
		leftLeg = new RendererModel(this, 50, 16);
		...
		rightWing = new RendererModel(this, 0, 48);
		...
		leftWing = new RendererModel(this, 0, 48);
		...
		rightWing2 = new RendererModel(this, 0, 48);
		...
		leftWing2 = new RendererModel(this, 0, 48);
		...
		rightWing3 = new RendererModel(this, 0, 48);
		...
		leftWing3 = new RendererModel(this, 0, 48);
	...
	public void setRotationAngles(EntityCirno entity, float movement, float far, float tick, float yaw, float pitch,
			float size) {
		super.setRotationAngles(entity, movement, far, tick, yaw, pitch, size);
		...
		if (entity.getSpellCardMotion() < -15) {
			rightArm.rotateAngleX = -0.7F - MathHelper.sin(tick / 10F) * 0.1F
					- MathHelper.sin((float) (30F + entity.getSpellCardMotion()) / 180F * 3.141593F) * 4F;
		} else if (entity.getSpellCardMotion() < 0) {
			rightArm.rotateAngleX = -0.7F - MathHelper.sin(tick / 10F) * 0.1F
					- MathHelper.sin((float) (-entity.getSpellCardMotion()) / 180F * 3.141593F) * 4F;
		} else {
			rightArm.rotateAngleX = -0.7F - MathHelper.sin(tick / 10F) * 0.1F;
		...
		if (entity.getFlyingHeight() > 0) {
			...
			this.rightWing.rotateAngleY = MathHelper.cos(tick * 0.1F) * (float) Math.PI * 0.1F
					+ (float) Math.PI * 0.15F;
			this.leftWing.rotateAngleY = -this.rightWing.rotateAngleY;
			this.rightWing2.rotateAngleY = MathHelper.cos(tick * 0.1F) * (float) Math.PI * 0.1F
					+ (float) Math.PI * 0.15F;
			this.leftWing2.rotateAngleY = -this.rightWing2.rotateAngleY;
			this.rightWing3.rotateAngleY = MathHelper.cos(tick * 0.1F) * (float) Math.PI * 0.1F
					+ (float) Math.PI * 0.15F;
			this.leftWing3.rotateAngleY = -this.rightWing2.rotateAngleY;
		}
	}
