...
@OnlyIn(Dist.CLIENT)
@IMobTextureProvider("textures/mob/reimu.png")
public class ModelReimu extends EntityModel<EntityReimu> {
	...
	public RendererModel skirtTop;
	public RendererModel skirtBottom;
	public RendererModel handRight;
	public RendererModel handLeft;
	public RendererModel longHair;
	public RendererModel braidRight;
	public RendererModel braidLeft;
	public RendererModel rightRibbon;
	public RendererModel rightRibbon2;
	public RendererModel leftRibbon;
	public RendererModel leftRibbon2;
	...
	public ModelReimu(float size, float yOffset, int textureXSize, int textureH)
	{
		...
		textureWidth = 64;
	      ...
	      skirtBottom = new RendererModel(this, 16, 33);
	      ...
	      longHair = new RendererModel(this, 0, 50);
	      ...
	      braidLeft = new RendererModel(this, 0, 32);
	      ...
	      braidRight = new RendererModel(this, 0, 32);
	      ...
	      leftRibbon = new RendererModel(this, 32, 56);
	      ...
	      rightRibbon = new RendererModel(this, 32, 56);
	      ...
	      rightRibbon2 = new RendererModel(this, 32, 56);
	      ...
	      leftRibbon2 = new RendererModel(this, 32, 56);
     ...
     */
	public void render(EntityReimu entity, float moveCounter, float moveCycle, float ticksExisted, float headYaw,
			float headPitch, float scale) {
		this.setRotationAngles(entity, moveCounter, moveCycle, ticksExisted, headYaw, headPitch, scale);
		bipedBody.render(scale);
	}

	@Override
	public void setRotationAngles(EntityReimu entity, float moveCounter, float moveCycle, float ticksExisted, float pheadYaw, float pheadPitch, float scale)
	{
	...
	public void setDefaultPause(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
	  ...
	  private void setRotation(RendererModel model, float rotateX, float rotateY, float rotateZ)
	  {
